...
export default function CheckoutOrderdetails() {
  ...
  useEffect(() => {
    fetch(
      `https://www.sultanaboutiques.com/backend/api/orderDetails/${checkOutInfo?.data?.order_id}`
    )
      .then((res) => res.json())
      .then((data) => setOrderDetails(data));
  }, [checkOutInfo?.data?.order_id]);
  ...
  return (
    <div className="changePasswordTab w-full">
      ...
      <div className="xl:flex xl:space-x-[30px] mt-5 mb-[30px]">
        <div className="xl:w-1/2 w-full rounded  h-[240px] flex flex-col item justify-center bg-gray-50  p-5">
