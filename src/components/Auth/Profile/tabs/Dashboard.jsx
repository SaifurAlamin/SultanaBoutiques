...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetch(
      ` https://sultanaboutiques.com/backend/api/order_count_statuswise/${
  ...
  return (
    <>
        ...
        <div className="welcome-msg w-full">
          <div>
            <p className="text-qblack text-lg">
              Hello,{" "}
              <span className="font-bold italic text-base lg:text-xl">
                {userdata?.name ? userdata?.name : googleUser?.user?.name}
              </span>
            </p>
            <h1 className="font-bold text-xl lg:text-2xl  text-qblack">
              Welcome to your Profile
            </h1>
          </div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-3">
          <div className="qv-item w-[222px] h-[178px] lg:w-[252px] rounded lg:h-[208px] bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6">
            ...
            <p className="text-xl text-white  mt-5">Pending</p>
            <span className="text-[30px] lg:text-[40px] text-white  font-bold leading-none mt-1 block">
              {pending?.total_order ? pending?.total_order : 0}
            </span>
          </div>
          <div className="qv-item w-[222px] h-[178px] lg:w-[252px] rounded lg:h-[208px] bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6">
            <div className="w-[62px] h-[62px] rounded bg-white flex justify-center items-center">
            ...
            <p className="text-xl text-white  mt-5">Processing</p>
            <span className="text-[30px] lg:text-[40px] text-white  font-bold leading-none mt-1 block">
              {Processing?.total_order ? Processing?.total_order : 0}
            </span>
          </div>
          <div className="qv-item w-[222px] h-[178px] lg:w-[252px] rounded lg:h-[208px] bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6">
            <div className="w-[62px] h-[62px] rounded bg-white flex justify-center items-center">
            ...
            <p className="text-xl text-white  mt-5">On The Way</p>
            <span className="text-[30px] lg:text-[40px] text-white  font-bold leading-none mt-1 block">
              {ontheway?.total_order ? ontheway?.total_order : 0}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden">
        <div className="welcome-msg w-full text-center">
          <div>
            <p className="text-qblack text-lg">
              Hello,{" "}
              <span className="font-bold italic text-base lg:text-xl">
        ...
        <div className=" mt-4">
          <div className="flex flex-col justify-center items-center gap-y-6">
            <div className="qv-item w-[252px] rounded h-[208px] bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6 text-center">
              <div className="w-[62px] h-[62px] rounded bg-white flex justify-center items-center mx-auto">
              ...
              <p className="text-xl text-white  mt-5">Pending</p>
              <span className="text-[35px] text-white  font-bold leading-none mt-1 block">
                {pending?.total_order ? pending?.total_order : 0}
              </span>
            </div>
            <div className="qv-item w-[252px] rounded h-[208px]   bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6 text-center">
              ...
              <p className="text-xl text-white  mt-5">Processing</p>
              <span className="text-[35px] lg:text-[40px] text-white  font-bold leading-none mt-1 block">
                {Processing?.total_order ? Processing?.total_order : 0}
              </span>
            </div>
            <div className="qv-item w-[252px] rounded h-[208px] bg-qblack group hover:bg-qh2-green transition-all duration-300 ease-in-out p-6 text-center">
      ...
      <div className="hidden lg:block">
        <div className="dashboard-info mt-8 flex justify-between items-center bg-primarygray px-7 py-7">
          ...
          <div className="mt-5">
            <table>
              <tr className="inline-flex mb-5 mr-4">
                <td className="text-base text-qgraytwo mr-2 block">
                  <div>Name:</div>
                </td>
              ...
              <tr className="inline-flex mb-5 ">
                ...
                <td className="text-base text-qblack font-medium mr-4">
                  {userdata?.email ? userdata?.email : googleUser?.user?.email}
                </td>
              </tr>
              <tr className="inline-flex mb-5">
                <td className="text-base text-qgraytwo mr-2 block">
                ...
                <td className="text-base text-qblack font-medium">
                  {userdata?.phone ? userdata?.phone : googleUser?.user?.phone}
                </td>
              </tr>
            </table>
          </div>
          ...
          <div className="mt-5">
            <table>
              ...
              <tr className="inline-flex mb-5">
                ...
                <td className="text-base text-qblack font-medium">3578</td>
              </tr>
            </table>
          </div>
        </div> */}
