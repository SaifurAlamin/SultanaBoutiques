...
export default function Login() {
  ...
  const from = location.state?.path || require || "/profile";
  ...
  const handleGoogleLogin = () => {
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        // Send the Google user details to your Laravel backend
        fetch("https://www.sultanaboutiques.com/backend/api/google-login", {
          method: "POST",
          headers: {
          ...
          .then((data) => {
            ...
            // Save the access token in localStorage or wherever needed
  ...
  const handleSubmit = (event) => {
    ...
    const url = "https://www.sultanaboutiques.com/backend/api/login";
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
  ...
  const handleResetPass = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://www.sultanaboutiques.com/backend/api/forgot-password`,
        data
        // {
        //   headers: {
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="signin-area mb-3.5">
                      <div className="flex justify-center">
                        <button
                          type="submit"
                          className="bg-rose-600 rounded mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center"
                        >
                          <span>Log In</span>
                        </button>
                      </div>
                      ...
                      <span
                        ...
                        className="w-full border border-qgray-border h-[50px] flex space-x-3  justify-center bg-[#e4dfdf] items-center cursor-pointer "
                      >
                        <svg
                          width="19"
                          height="20"
