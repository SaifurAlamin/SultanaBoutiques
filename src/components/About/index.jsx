      ...
      <div className="about-page-wrapper w-full">
        ...
        <div className="aboutus-wrapper w-full">
          <div className="container-x mx-auto">
            <div className="w-full min-h-[805px] lg:flex lg:space-x-12 items-center pb-6 lg:pb-0">
              <div className="md:w-[570px] w-full h-[250px] lg:h-[650px] rounded overflow-hidden my-2 lg:my-0">
                <img
              ...
              <div className="content flex-1">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: about_us }}
                ></div>
                ...
                <Link to="/contact">
                  <div className="w-[180px] h-[50px] mt-4">
                    <button
                      type="submit"
                      className="bg-rose-600 rounded h-[40px] w-44 text-white"
                    >
