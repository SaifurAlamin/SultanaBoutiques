...
export default function DashboardDrawer({ className, open, action }) {
        ...
        >
          ...
          <div className="w-full mt-5 px-5">
            <div className="search-bar w-full h-[34px]  flex ">
              ...
              <div className="w-[50px] h-[40px] rounded-sm bg-gray-900  flex justify-center items-center">
            ...
            <div className="menu-item mt-5 w-full">
              <ul className="categories-list">
                <li className="category-item">
                  <Link to="/">
                    <div className=" flex justify-start items-center px-5 h-12 bg-white hover:bg-qyellow transition-all duration-300 ease-in-out cursor-pointer">
                      <div className="flex items-center space-x-6">
                  ...
                  <li className="category-item">
                    ...
                    <ul className="submenu-list ml-5">
                      {item?.subcategory?.map((subItem) => (
                        <li className="category-item">
                          <Link to={`/all-products/${item?.id}/${subItem?.id}`}>
                            <div className=" flex justify-between items-center px-5 h-12 bg-white hover:bg-qyellow transition-all duration-300 ease-in-out cursor-pointer">
                              <div className="flex items-center space-x-6">
